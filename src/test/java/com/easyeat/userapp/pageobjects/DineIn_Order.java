...
public class DineIn_Order {
			
		WebDriver ldriver;
		WebDriverWait wait;
		
		public DineIn_Order(WebDriver rdriver) {
			 ldriver=rdriver;
		...
		@CacheLookup
		public WebElement click_startordering;
		
		@FindBy(xpath = "//*[@class='h5']")
		@CacheLookup
		public WebElement verify_restaurant;
		
		@FindBy(xpath = "//div[@class='text-secondary fs-14']")
		@CacheLookup
		public WebElement verify_ordertype;
		
		@FindBy(xpath = "//*[contains( text(),'OPEN MENU')]")
		@CacheLookup
		public WebElement click_openmenu;
		...
		@FindBy(xpath = "//div[contains(text(),'Login To Place Order')]")
		@CacheLookup
		public
		...
		@CacheLookup
		public
		WebElement click_placeorder;
		
		@FindBy(xpath = "//*[contains( text(),'Pay now')]")
		@CacheLookup
		public
		WebElement click_paynoworderstatus;
		...
		@CacheLookup
		public WebElement click_addmore;
